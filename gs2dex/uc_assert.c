/*---------------------------------------------------------------------
	...
	$Id: uc_assert.c,v 1.5 1997/08/07 03:24:26 yasu Exp $
  ---------------------------------------------------------------------*/
#include	<ultra64.h>

/*==========================================================================*
 *  The assert judgment of ucode. 
 *==========================================================================*/
u32	ucCheckAssert(void)
{
  /*
   * When the abnormal end occurs to S2DEX ucode, SP_STATUS_SIG7 stands.  
   */
...
/*==========================================================================*
 *  Output the DL log 
 *     RSP outputs the processed command log.  
 *==========================================================================*/
void	ucDebugGfxLogPrint(OSTask *tp)
{
  ...
  /*------ The output position of the present log is stored in this position. ------*/
...
void	ucDebugRdpFifoPrint(OSTask *tp)
{
  ...
  for (n = fifotop; n < fifoend; n += 8){
    ...
    if (count > 0){
      ...
      if (8 <= head && head <= 15){		/* The Triangle command. */
	count = count_rdp[head-8] - 8;
      } else if (head == 0x24 || head == 0x25){	/* The TextureRectangle command. */
	count = 8;
      }
    }
...
/*==========================================================================*
 *  Output the Assert information data.  
 *==========================================================================*/
