...
extern char _gfxdlistsSegmentEnd[];
    ...
    cartCopy(_staticSegmentRomStart, staticSegment, len);
#else
    u32 len = (u32)_staticSegmentDiskEnd - (u32)_staticSegmentDiskStart;
    staticSegment = _gfxdlistsSegmentStart;
    ddCopy((u32)_staticSegmentDiskStart, staticSegment, len);
#endif
